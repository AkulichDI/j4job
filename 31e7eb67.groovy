...
void closeResolvedTasks(List tasks) {
...
void reassignOpenTasks(List tasks, def targetOU) {
...
void processEmployee(String name) {
    ...
    List resolvedTasks = getResolvedTasks(emp)
    ...
    List openTasks = getOpenTasks(emp)
