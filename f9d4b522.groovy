...
class Report {
    ...
    String getSummary() {
        ...
        result.append("Найдено сотрудников: $found\n")
...
boolean hasLicense(def emp) {
    ...
    try {
        ...
        String licenseName = license.toString().toLowerCase()
        
        if (licenseName == 'notlicensed' || licenseName == 'not licensed' || licenseName == 'нет лицензии') {
            return false
        }
